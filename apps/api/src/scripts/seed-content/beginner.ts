...
`.trim(),
    ...
    questions: [
      ...
      },
      {
        ...
        weight: 1,
        promptMd:
          "What's the simplest way to recover the file's contents from this evidence?",
        textMatch: {
          acceptableAnswers: [
            "rename $r",
            "copy $r",
        ...
        debriefMd:
          "Copy or rename the `$R...` file — it IS the original bytes, just under a different name. In an investigation you'd preserve the file rather than restore-in-place so the on-disk evidence isn't disturbed.",
      },
      {
        ordinal: 3,
        type: "confidence",
...
`.trim(),
    ...
    questions: [
      ...
      },
      {
        ...
        weight: 1,
        promptMd:
          "Which additional artifact would best tell you whether the user actually OPENED the downloaded file?",
        textMatch: {
          acceptableAnswers: [
            "prefetch",
            "recent files",
        ...
        debriefMd:
          "Any of: LNK files in `%APPDATA%\\Microsoft\\Windows\\Recent`, the application's jumplist, UserAssist, recent-files MRU lists, or (for executables) Prefetch. Each captures a different angle of \"file was opened.\"",
      },
      {
        ordinal: 3,
        type: "confidence",
...
`.trim(),
    ...
    questions: [
      ...
      },
      {
        ...
        weight: 1,
        promptMd:
          "Name the single artifact (one phrase) that would best close the gap between Transfer 2 and Transfer 3.",
        textMatch: {
          acceptableAnswers: [
            "door access log",
            "door-access log",
        ...
        debriefMd:
          "The door-access / keycard log for station 7 during that window. It either shows no swipes (gap closes — no one accessed the locker) or names every person who did (each becomes a follow-up).",
      },
      {
        ordinal: 3,
        type: "confidence",
