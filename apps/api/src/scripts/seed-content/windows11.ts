...
`.trim(),
    artifacts: [
      ...
      },
      {
        ...
        bytes: utf8(
          [
            "ipconfig /displaydns  (excerpt)",
            "-------------------------------",
            "",
            "Note: the host resolver cache rotates rapidly. This snapshot",
            "was taken at acquisition (2026-10-15T07:12Z) and reflects",
            "names still cached at that moment — earlier resolutions may",
            "have aged out.",
            "",
    ...
    artifacts: [
      {
        ...
        bytes: utf8(
          [
            "C:\\Windows\\Prefetch  (WSL-related excerpt)",
            "------------------------------------------",
            "",
            "  WSL.EXE-AABBCC01.pf",
            "    first run: 2026-09-10T13:00:01Z",
            "    last run:  2026-11-04T22:14:08Z",
            "    run count: 41",
            "",
            "  WSLHOST.EXE-AABBCC02.pf",
            "    first run: 2026-09-10T13:00:02Z",
            "    last run:  2026-11-04T22:14:09Z",
            "    run count: 41",
            "",
            "  VMCOMPUTE.EXE-AABBCC03.pf",
            "    (system-service prefetch; first/last reflect cumulative service starts, not user invocations)",
            "",
          ].join("\n"),
        ),
      },
      ...
      },
      {
        ...
        bytes: utf8(
          [
            "Directory listing — WSL distro storage (acquired offline)",
            "---------------------------------------------------------",
            "",
            "%LOCALAPPDATA%\\Packages\\CanonicalGroupLimited.Ubuntu22.04LTS_79rhkp1fndgsc\\LocalState\\",
            "  ext4.vhdx         9_812_345_344  2026-11-04T22:14:00Z  -a----",
            "",
            "%LOCALAPPDATA%\\Packages\\KaliLinux.54290C8133FEE_ey8k8hqnwqnmg\\LocalState\\",
            "  ext4.vhdx         3_220_115_456  2026-11-04T22:13:58Z  -a----",
            "",
            "Notes:",
            "  - VHDX last-modified reflects the last time the file was open + written to (i.e., last time the distro was running and writing).",
            "  - VHDX size grows as the distro fills; it does NOT shrink on file deletion inside the VM.",
            "  - File contents are NOT readable from the host without mounting the VHDX (must be done with distro stopped).",
            "",
          ].join("\n"),
        ),
      },
...
`.trim(),
    artifacts: [
      ...
      },
      {
        ...
        bytes: utf8(
          [
            "C:\\Windows\\Prefetch  (binaries of interest)",
            "------------------------------------------",
            "",
            "  7Z2400-X64.EXE-XXXX0001.pf      first 2026-11-29T16:14:08Z  last 2026-11-29T16:14:08Z  count 1",
            "  7ZG.EXE-XXXX0002.pf             first 2026-12-02T18:48:00Z  last 2026-12-02T18:50:00Z  count 2",
            "  ROBOCOPY.EXE-XXXX0003.pf        first 2026-09-04T10:00:00Z  last 2026-12-02T19:04:33Z  count 7",
            "  ONEDRIVE.EXE-XXXX0004.pf        first 2026-08-01T08:00:00Z  last 2026-12-03T08:00:00Z  count 412",
            "  RCLONE.EXE-XXXX0005.pf          first 2026-12-03T20:18:22Z  last 2026-12-03T20:18:22Z  count 1",
            "  FIREFOX.EXE-XXXX0006.pf         first 2026-08-01T08:00:00Z  last 2026-12-03T21:35:55Z  count 88",
            "",
          ].join("\n"),
        ),
      },
      ...
      },
      {
        ...
        bytes: utf8(
          [
            "OneDrive client log  (per-file events, d.becker account, excerpt)",
            "-----------------------------------------------------------------",
            "",
            "2026-12-02T19:06:51Z  UPLOAD-START  C:\\Users\\d.becker\\OneDrive\\handoff\\client-list-2026.xlsx (8.4 MB)",
            "2026-12-02T19:07:14Z  UPLOAD-DONE   ... (status: success; target: corporate OneDrive)",
            "2026-12-02T19:07:14Z  UPLOAD-START  C:\\Users\\d.becker\\OneDrive\\handoff\\pipeline-q4.docx (220 KB)",
            "2026-12-02T19:07:18Z  UPLOAD-DONE   ... (status: success; target: corporate OneDrive)",
            "2026-12-02T19:08:00Z  UPLOAD-START  C:\\Users\\d.becker\\OneDrive\\handoff\\handoff-archive.7z (38 MB)",
            "2026-12-02T19:08:55Z  UPLOAD-DONE   ... (status: success; target: corporate OneDrive)",
            "",
            "(Note: OneDrive target above is the CORPORATE tenant. Personal-account OneDrive is blocked by Conditional Access on this host.)",
            "",
          ].join("\n"),
        ),
      },
